	...
	mach_msg_size_t rcv_size;
{
	...
	/*
	 *	We don't have anywhere to put rights and memory
	 *	in the reply message.  Destroy all rights and memory
	 *	and consume the send-once right for the reply port.
	 */
