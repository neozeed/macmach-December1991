...
typedef struct zone_info {
	int		zi_count;	/* Number of elements used now */
	...
	boolean_t	zi_pageable;	/* zone pageable? */
	boolean_t	zi_sleepable;	/* sleep if empty? */
	boolean_t	zi_exhaustible;	/* merely return if empty? */
	boolean_t	zi_collectable;	/* garbage collect elements? */
} zone_info_t;
