 ...
 * HISTORY
 * $Log:	main.c,v $
 * Revision 2.2  91/05/13  06:03:01  af
 * 	Made code under CMU standard.
 * 	[91/05/12  15:52:01  af]
 * 
 * Revision 2.1  89/08/03  15:36:36  rwd
 * Created.
 * 
 *  3-Nov-87  David Black (dlb) at Carnegie-Mellon University
 *	Added local symbol expansion for multimax assembler.
 *
 * 25-Apr-87  Michael Young (mwyoung) at Carnegie-Mellon University
 *	Eliminate silly "warning: can't verify arg count for mumble"
 *	messages; the "-w" switch will turn them back on.
 **********************************************************************
 */ 
...
#ifndef lint
static char sccsid[] = "@(#)main.c	7.1 (Berkeley) 6/5/86";
#endif not lint
...
/*
 * The pattern tables to be loaded
 * are defined in machdep.c
 */
