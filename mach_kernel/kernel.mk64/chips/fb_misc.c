 ...
 * HISTORY
 * $Log:	fb_misc.c,v $
 * Revision 2.2  91/08/24  11:51:58  af
	...
	unsigned int	status_count;
{
	...
	case SCREEN_SET_CURSOR_COLOR:
		bt455_cursor_color (fb->vdac_registers, (color_map_t*) status);
		break;
	...
	screen_softc_t	sc;
{
	...
	fb_small_cursor_to_large(sc->up, dc503_default_cursor);
	bt431_cursor_sprite(fb->cursor_registers, sc->up->dev_dep_2.pm.cursor_sprite);
}
