...
typedef struct {
  ...
  union {
	...
	unsigned char	Bg_color[3];	/* Kdep */
	unsigned char	Fg_color[3];	/* Kdep */
	int		tablet_scale_x;	/* Kuse */
	int 		tablet_scale_y;	/* Kuse */
    } pm;
    struct {
	char *		x26	/* gxo */;
	char		x27_1	/* stamp_width */;
	char		x27_2	/* stamp_height */;
	char		x27_3	/* nplanes */;
	char		x27_4	/* n10_present */;
	char		x28_1	/* dplanes */;
	char		x28_2	/* zplanes */;
	char		x28_3	/* zzplanes */;
	unsigned char	x29[1024]	/* curs_bits */;
	int		x285	/* curs_fg */;
	int		x286	/* curs_bg */;
	unsigned short	x287	/* cmap_index */;
	unsigned short	x288	/* cmap_count */;
	int		x289[256]	/* colormap */;
	int *		x290	/* stic_dma_rb */;
	int *		x291	/* stic_reg */;
	int		x292	/* ptpt_phys */;
	int		x293	/* ptpt_size */;
	int *		x294	/* ptpt_pgin */;
