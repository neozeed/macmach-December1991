 ...
 * HISTORY
 * $Log:	nmxlog.c,v $
 * Revision 2.1  90/10/27  20:47:22  dpj
 * Moving under MACH3 source control
 * 
 * Revision 1.6  89/05/02  11:20:51  dpj
 ...
 */
#ifndef	lint
static char     rcsid[] = "$Header: /afs/cs.cmu.edu/project/mach-2/rcs/pkg/netmsg/utils/nmxlog.c,v 2.1 90/10/27 20:47:22 dpj Exp $";
#endif not lint
/*
