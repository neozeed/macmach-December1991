 ...
 * HISTORY
 * $Log:	nmtime.c,v $
 * Revision 2.1  90/10/27  20:47:20  dpj
 * Moving under MACH3 source control
 * 
 * Revision 1.6.2.1  90/08/02  20:24:37  dpj
 * 	From NeXT:
 * 		Print a dot on each transfer.
 * 		Do not call init_netname() on a NeXT.
 * 	[90/06/03  17:47:19  dpj]
 * 
 * Revision 1.6  89/05/02  11:20:41  dpj
 ...
 */
#ifndef	lint
static char     rcsid[] = "$Header: /afs/cs.cmu.edu/project/mach-2/rcs/pkg/netmsg/utils/nmtime.c,v 2.1 90/10/27 20:47:20 dpj Exp $";
#endif not lint
/*
...
BEGIN("printmenu")
	...
	fprintf(stdout, "    D.........Print a dot on each transfer\n");
	fprintf(stdout, "\n");
...
BEGIN("initialize")
	 ...
	 */
#ifndef	NeXT
#ifndef mac2 /* mac2 does not provide init_netname() */
