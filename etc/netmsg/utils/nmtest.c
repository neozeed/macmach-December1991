 ...
 * HISTORY
 * $Log:	nmtest.c,v $
 * Revision 2.2  90/10/29  17:56:52  dpj
 * 	Moving under MACH3 source control.
 * 	Correcting mysteriously truncated file.
 * 	[90/10/27            dpj]
 * 
 * Revision 1.5  90/01/24  23:08:35  mrt
 * 	Small fix to keep multimax compiler happy
 * 	[90/01/18            dlb]
 * 
 ...
 */
#ifndef	lint
static char     rcsid[] = "$Header: /afs/cs.cmu.edu/project/mach-2/rcs/pkg/netmsg/utils/nmtest.c,v 2.2 90/10/29 17:56:52 dpj Exp $";
#endif not lint
/*
...
BEGIN("receive_main")
	...
	for (;;) {
		rcv_buff = (struct my_msg *)&(rcv_msg[0]);
