 ...
 * HISTORY
 * $Log:	mem.c,v $
 * Revision 2.1  90/10/27  20:44:44  dpj
 * Moving under MACH3 source control
 * 
 * Revision 1.32  90/01/24  23:08:26  mrt
 * 	Removed include of <mach/vm_param.h>.
 * 	[90/01/19            mrt]
 * 
...
#ifndef	lint
char mem_rcsid[] = "$Header: /afs/cs.cmu.edu/project/mach-2/rcs/pkg/netmsg/server/mem.c,v 2.1 90/10/27 20:44:44 dpj Exp $";
#endif not lint
