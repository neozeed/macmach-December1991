 ...
 * HISTORY
 * $Log:	pc_startup.c,v $
 * Revision 2.1  90/10/27  20:45:35  dpj
 * Moving under MACH3 source control
 * 
 * Revision 1.9  89/05/02  11:15:12  dpj
...
#ifndef	lint
char pc_startup_rcsid[] = "$Header: /afs/cs.cmu.edu/project/mach-2/rcs/pkg/netmsg/server/pc_startup.c,v 2.1 90/10/27 20:45:35 dpj Exp $";
#endif not lint
