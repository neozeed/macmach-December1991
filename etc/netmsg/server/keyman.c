 ...
 * HISTORY
 * $Log:	keyman.c,v $
 * Revision 2.1  90/10/27  20:44:24  dpj
...
#ifndef	lint
char keyman_rcsid[] = "$Header: /afs/cs.cmu.edu/project/mach-2/rcs/pkg/netmsg/server/keyman.c,v 2.1 90/10/27 20:44:24 dpj Exp $";
#endif not lint
