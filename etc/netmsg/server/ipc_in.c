 ...
 * HISTORY
 * $Log:	ipc_in.c,v $
 * Revision 2.1  90/10/27  20:44:12  dpj
 * Moving under MACH3 source control
 * 
 * Revision 1.27  90/01/24  23:08:08  mrt
 * 	Removed include of <vm_param.h>.
 * 	[90/01/19            mrt]
 * 
 ...
 */
#ifndef	lint
char ipc_in_rcsid[] = "$Header: /afs/cs.cmu.edu/project/mach-2/rcs/pkg/netmsg/server/ipc_in.c,v 2.1 90/10/27 20:44:12 dpj Exp $";
#endif not lint
/*
