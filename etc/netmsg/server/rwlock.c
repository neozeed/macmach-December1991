 ...
 * HISTORY
 * $Log:	rwlock.c,v $
 * Revision 2.1  90/10/27  20:46:01  dpj
...
#ifndef	lint
char rwlock_rcsid[] = "$Header: /afs/cs.cmu.edu/project/mach-2/rcs/pkg/netmsg/server/rwlock.c,v 2.1 90/10/27 20:46:01 dpj Exp $";
#endif not lint
