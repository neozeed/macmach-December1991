 ...
 * HISTORY
 * $Log:	nm_enable.c,v $
 * Revision 2.1  90/10/27  20:45:22  dpj
 * Moving under MACH3 source control
 * 
 * Revision 1.5  89/05/02  11:14:07  dpj
 ...
 */
#ifndef	lint
char nm_enable_rcsid[] = "$Header: /afs/cs.cmu.edu/project/mach-2/rcs/pkg/netmsg/server/nm_enable.c,v 2.1 90/10/27 20:45:22 dpj Exp $";
#endif not lint
