...
/*
 * HISTORY
 * $Log:	deltat_utils.c,v $
 * Revision 2.1  90/10/27  20:44:00  dpj
 * Moving under MACH3 source control
 * 
 * Revision 1.28.1.1  90/08/15  14:57:32  dpj
 * 	Updated for MACH3_SA.
 * 
 * Revision 1.28  89/05/02  11:08:22  dpj
 * 	Fixed all files to conform to standard copyright/log format
 * 
 * Revision 1.27  89/04/24  20:38:42  dpj
 * 	Changes from NeXT as of 88/09/30
 * 
 * 	 13-Oct-87 Mary R. Thompson (mrt) at Carnegie Mellon
 * 	[89/04/19  19:10:57  dpj]
 * 
 * Revision 1.26  88/10/14  16:16:15  mrt
 * Changed queue_item_t to cthread_queue_item_t
 * 
 * Revision 1.25  88/10/08  22:24:21  dpj
 * 	Added USE_DELTAT.
 * 
 *	Changed queue_item_t to cthread_queue_item_t.
 *
 ...
 */
#ifndef	lint
char deltat_utils_rcsid[] = "$Header: /afs/cs.cmu.edu/project/mach-2/rcs/pkg/netmsg/server/deltat_utils.c,v 2.1 90/10/27 20:44:00 dpj Exp $";
#endif not lint
/*
...
BEGIN("deltat_utils_init")
    ...
    current_incarnation = tp.seconds;
#else	MACH3_SA || MACH3_US
