 ...
 * HISTORY
 * $Log:	ipc_block.c,v $
 * Revision 2.1  90/10/27  20:44:07  dpj
...
#ifndef	lint
char ipc_block_rcsid[] = "$Header: /afs/cs.cmu.edu/project/mach-2/rcs/pkg/netmsg/server/ipc_block.c,v 2.1 90/10/27 20:44:07 dpj Exp $";
#endif not lint
