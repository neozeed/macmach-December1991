 ...
 * HISTORY
 * $Log:	netname.c,v $
 * Revision 2.1  90/10/27  20:45:03  dpj
 * Moving under MACH3 source control
 * 
 * Revision 1.20.1.1.1.2  90/08/02  20:23:16  dpj
 * 	Use explicit port set instead of port_enable/port_disable.
 * 	[90/06/03  17:38:25  dpj]
 * 
 * Revision 1.20.1.1.1.1  90/07/30  14:00:06  dpj
 * 	Defined NET_PRINT.
 * 
...
#ifndef	lint
char netname_rcsid[] = "$Header: /afs/cs.cmu.edu/project/mach-2/rcs/pkg/netmsg/server/netname.c,v 2.1 90/10/27 20:45:03 dpj Exp $";
#endif not lint
...
#ifndef mac2 /* mac2 does not provide init_service() */
