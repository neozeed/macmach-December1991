 ...
 * HISTORY
 * $Log:	trint_test.c,v $
 * Revision 2.1  90/10/27  20:46:56  dpj
...
#ifndef	lint
char trint_test_rcsid[] = "$Header: /afs/cs.cmu.edu/project/mach-2/rcs/pkg/netmsg/server/trint_test.c,v 2.1 90/10/27 20:46:56 dpj Exp $";
