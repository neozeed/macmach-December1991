 ...
 * HISTORY
 * $Log:	nn_handler.c,v $
 * Revision 2.1  90/10/27  20:45:31  dpj
...
#ifndef	lint
char nn_handler_rcsid[] = "$Header: /afs/cs.cmu.edu/project/mach-2/rcs/pkg/netmsg/server/nn_handler.c,v 2.1 90/10/27 20:45:31 dpj Exp $";
#endif not lint
