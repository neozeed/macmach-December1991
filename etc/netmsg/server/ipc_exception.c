...
/*
 * HISTORY
 * $Log:	ipc_exception.c,v $
 * Revision 2.1  90/10/27  20:44:08  dpj
 * Moving under MACH3 source control
 * 
 * Revision 1.7.2.1  90/08/02  20:22:02  dpj
 * 	Removed a "&" to avoid a compiler warning.
 * 	[90/06/03  17:32:12  dpj]
 * 
 * Revision 1.7  89/05/02  11:09:10  dpj
 ...
 */
#ifndef	lint
char ipc_exception_rcsid[] = "$Header: /afs/cs.cmu.edu/project/mach-2/rcs/pkg/netmsg/server/ipc_exception.c,v 2.1 90/10/27 20:44:08 dpj Exp $";
#endif not lint
/*
 * */
