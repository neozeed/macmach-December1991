 ...
 * HISTORY
 * $Log:	portcheck.c,v $
 * Revision 2.1  90/10/27  20:45:46  dpj
...
#ifndef	lint
char portcheck_rcsid[] = "$Header: /afs/cs.cmu.edu/project/mach-2/rcs/pkg/netmsg/server/portcheck.c,v 2.1 90/10/27 20:45:46 dpj Exp $";
#endif not lint
