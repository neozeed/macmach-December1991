 ...
 * HISTORY
 * $Log:	port_test.c,v $
 * Revision 2.1  90/10/27  20:45:45  dpj
 * Moving under MACH3 source control
 * 
 * Revision 1.10  89/05/02  11:15:49  dpj
...
#ifndef	lint
char port_test_rcsid[] = "$Header: /afs/cs.cmu.edu/project/mach-2/rcs/pkg/netmsg/server/port_test.c,v 2.1 90/10/27 20:45:45 dpj Exp $";
#endif not lint
