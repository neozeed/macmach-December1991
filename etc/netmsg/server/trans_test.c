 ...
 * HISTORY
 * $Log:	trans_test.c,v $
 * Revision 2.1  90/10/27  20:46:51  dpj
...
#ifndef	lint
char trans_test_rcsid[] = "$Header: /afs/cs.cmu.edu/project/mach-2/rcs/pkg/netmsg/server/trans_test.c,v 2.1 90/10/27 20:46:51 dpj Exp $";
#endif not lint
