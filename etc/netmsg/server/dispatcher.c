 ...
 * HISTORY
 * $Log:	dispatcher.c,v $
 * Revision 2.1  90/10/27  20:44:04  dpj
 * Moving under MACH3 source control
 * 
 * Revision 1.14  89/05/02  11:08:41  dpj
...
#ifndef	lint
char dispatcher_rcsid[] = "$Header: /afs/cs.cmu.edu/project/mach-2/rcs/pkg/netmsg/server/dispatcher.c,v 2.1 90/10/27 20:44:04 dpj Exp $";
#endif not lint
