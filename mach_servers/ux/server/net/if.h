 ...
 * HISTORY
 * $Log:	if.h,v $
 * Revision 2.1  89/08/04  14:17:34  rwd
 * Created.
 * 
 * 24-Aug-87  Richard Sanzi (sanzi) at Carnegie-Mellon University
 *	Added IFF_SNAP and IFF_BRIDGE definitions to support backward
 *	compatability for the RT lan driver.
 */
/*
...
#define	IFF_BRIDGE	0x1000		/* support token ring routing field */
