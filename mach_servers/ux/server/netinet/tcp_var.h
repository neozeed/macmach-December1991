 ...
 * HISTORY
 * $Log:	tcp_var.h,v $
 * Revision 2.1  89/08/04  14:26:04  rwd
 * Created.
 * 
 * 27-Nov-87  Mike Accetta (mja) at Carnegie-Mellon University
 *	Upgraded to version 7.5 (Berkeley).
 *	[ V5.1(XF21) ]
 *
 **********************************************************************
 */ 
...
/*
 * Bill Nowicki (correctly) pointed out that the page size (CLBYTES)
 * has nothing to do with the mbuf cluster size.  So, we followed
