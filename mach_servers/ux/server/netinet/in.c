 ...
 * HISTORY
 * $Log:	in.c,v $
 * Revision 2.2  90/05/29  20:24:06  rwd
 * 	Picked up jsb changes to allow the netmsgserver to do broadcasts.
 * 	[90/03/19            rwd]
 * 
 * Revision 2.1  89/08/04  14:22:14  rwd
 * Created.
 * 
