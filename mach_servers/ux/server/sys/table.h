 ...
 * HISTORY
 * $Log:	table.h,v $
 * Revision 2.2  90/06/02  15:25:58  rpd
 * 	Added TBL_BOOTTIME.
 * 	[90/04/27            rpd]
 * 
 * Revision 2.1  89/08/04  14:48:43  rwd
 * Created.
 * 
...
#define	TBL_MACHFACTOR		12	/* (no index) */
...
/*
 *  TBL_MACHFACTOR data layout
 */

struct tbl_machfactor
{
	long tmf_machfactor[3];
	int tmf_lscale;
};
...
/*
 *	TBL_BOOTTIME data layout
 */
struct tbl_boottime
{
    struct timeval tbt_time;	/* boot time */
};
