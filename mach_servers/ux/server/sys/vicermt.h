 ...
 * HISTORY
 * $Log:	vicermt.h,v $
 * Revision 2.6  91/09/03  11:13:36  jsb
 * 	From Intel SSD: Added i860 case.
 * 	[91/09/02  14:19:05  jsb]
 * 
 * Revision 2.5  90/06/02  15:26:29  rpd
 * 	Redefined RT_MAX_ARGS to avoid use of u.u_arg.
 * 	[90/05/13            rpd]
 * 
 * Revision 2.4  90/05/21  14:00:19  dbg
 * 	Fixed i386 definition not to collide with 'blit'.
 * 	[90/05/03            dbg]
 * 	Added i386 definitions.
 * 	[90/04/23            dbg]
 * 
 * Revision 2.3  90/03/14  21:30:09  rwd
 * 	Change PINOD+1 to PSPECL.
 * 	[90/02/16            rwd]
 * 
 * Revision 2.2  89/11/29  15:30:07  af
 * 	Definitions for mips.
 * 	[89/11/16  17:07:57  af]
 * 
 * Revision 2.1  89/08/04  14:50:03  rwd
 * Created.
 * 
...
#endif	mips
/* Sleep priorities */
#define	RMT_NOINT_PRI	(PSPECL) /* Disallow aborts due to signal handling */
#define	RMT_INTOK_PRI	(PSLEP-1)/* Sleep with signal handling enabled */
