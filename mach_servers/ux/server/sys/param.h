 ...
 * HISTORY
 * $Log:	param.h,v $
 * Revision 2.3  90/06/02  15:25:32  rpd
 * 	Cleaned up conditionals; removed MACH, CMU, CMUCS, MACH_NO_KERNEL.
 * 	[90/04/28            rpd]
 * 
 * Revision 2.2  90/03/14  21:29:02  rwd
 * 	Add PSPECL.  This will release a cthread in the server but
 * 	is not interruptable in sleep.
 * 	[90/02/16            rwd]
 * 
 * Revision 2.1  89/08/04  14:47:48  rwd
 * Created.
 * 
