 ...
 * HISTORY
 * $Log:	mkswapconf.c,v $
 * Revision 2.2  90/05/21  13:56:57  dbg
 ...
 * Created.
 * 
 * Revision 2.6  89/02/25  19:24:25  gm0w
 * 	Changes for cleanup.
 * 
 * Revision 2.5  89/02/19  19:01:59  rpd
 * 	Made the emitted #include lines use <> instead of "".
 * 	
 * 	Updated initdevtable() to use config_directory, fopenp.
 * 	It also skips comment lines (start with #) and blank lines now.
 * 
 * Revision 2.4  89/02/07  22:55:48  mwyoung
 * Code cleanup cataclysm.
 * 
 * Revision 2.3  89/01/23  22:24:25  af
 * 	Changes for MIPS
 * 	[89/01/09            rvb]
 * 
