char *userv = "User Interface 5A(076), 5 Nov 91";
...
extern char *DIRCMD, *PWDCMD, *DELCMD, *WHOCMD, *TYPCMD;
extern char optbuf[], ttname[], filnam[];
extern CHAR sstate;
extern CHAR *zinptr;
...
#ifndef MAC
CHAR keymap[256] = {			/* Key map for SET KEY */
...
176, 177, 178, 179, 180, 181, 182, 183, 184, 185, 186, 187, 188, 189, 189, 191,
...
/* Variables and symbols local to ckuus*.c modules. */
...
#ifndef NOSPL
#ifdef COMMENT				/* (dumb syntax) */
    "append",      XXAPP, 0,		/* append (to log) */
#endif /* COMMENT */
