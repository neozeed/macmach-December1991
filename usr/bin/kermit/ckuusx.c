...
stptrap(sig) int sig; {
	...
	switch (what) {
	  ...
	  default:			/* All other cases... */
	    ...
	    concb(escape);		/* Put it back in CBREAK mode */
	    break;
	}
    }
}
...
int
dodebug(f,s1,s2,n) int f, n; char *s1, *s2; {
    char *sp;
