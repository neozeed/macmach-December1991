...
extern int pkttim, rtimo, local, nfils, rprintf, displa, atcapr, nettype;
extern int mdmtyp, duplex, dfloc, network, cdtimo, fncact, mypadn;
extern int tnlm, sosi, tlevel, lf_opts;
extern int
...
extern char tmpbuf[], *tp;		/* Another of the same */
