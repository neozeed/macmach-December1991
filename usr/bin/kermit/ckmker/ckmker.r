...
/*			header. Changed "Restore Settingsä" to "Load */
...
resource 'MENU' (1, preload) {
	...
	{	/* array: 2 elements */
		/* [1] */
		"About Kermitä", noIcon, noKey, noMark, plain,
		/* [2] */
...
resource 'MENU' (3) {
	...
	{	/* array: 8 elements */
		/* [1] */
		"Load Settingsä", noIcon, noKey, noMark, plain,
		/* [2] */
		"Save Settingsä", noIcon, noKey, noMark, plain,
		/* [3] */
		"-", noIcon, noKey, noMark, plain,
		/* [4] */
		"Get file from serverä", noIcon, "G", noMark, plain,
		/* [5] */
		"Send fileä", noIcon, "S", noMark, plain,
		/* [6] */
		"Receive fileä", noIcon, "R", noMark, plain,
		/* [7] */
		"Transfer statsä", noIcon, noKey, noMark, plain,
		/* [8] */
		"Set transfer directoryä", noIcon, noKey, noMark, plain,
		/* [9] */
		"-", noIcon, noKey, noMark, plain,
		/* [10] */
		"Transfer to Appä", noIcon, "T", noMark, plain,
		/* [11] */
...
resource 'MENU' (35) {
	...
	{	/* array: 8 elements */
		...
		"-", noIcon, noKey, noMark, plain,
		/* [4] */
		"Get file from serverä", noIcon, noKey, noMark, plain,
		/* [5] */
		"Send fileä", noIcon, noKey, noMark, plain,
		/* [6] */
		"Receive fileä", noIcon, noKey, noMark, plain,
		/* [7] */
		"Transfer statsä", noIcon, noKey, noMark, plain,
		/* [8] */
		"Set transfer directoryä", noIcon, noKey, noMark, plain,
		...
		"-", noIcon, noKey, noMark, plain,
		/* [10] */
		"Transfer to Appä", noIcon, noKey, noMark, plain,
		/* [11] */
...
resource 'MENU' (5) {
	...
	{	/* array: 12 elements */
		/* [1] */
		"File Defaultsä", noIcon, noKey, noMark, plain,
		/* [2] */
		"Communicationsä", noIcon, noKey, noMark, plain,
		/* [3] */
		"Protocolä", noIcon, noKey, noMark, plain,
		/* [4] */
		"Terminalä", noIcon, noKey, noMark, plain,
		/* [5] */
		"Character Setä", noIcon, noKey, noMark, plain,
		/* [6] */
		"-", noIcon, noKey, noMark, plain,
		/* [7] */
		"\0x11-Shift-1ä\0x11-Shift-9 active", noIcon, noKey,
		    check, plain,
		/* [8] */
		"Menu \0x11-Keys active", noIcon, "M", noMark, plain,
		/* [9] */
		"Set key macrosä", noIcon, noKey, noMark, plain,
		/* [10] */
		"Set modifiersä", noIcon, noKey, noMark, plain
	}
};
resource 'MENU' (37) {
	5,
...
resource 'MENU' (6) {
	...
	{	/* array: 15 elements */
		...
		"-", noIcon, noKey, noMark, plain,
		/* [6] */
		"Cwdä", noIcon, noKey, noMark, plain,
		/* [7] */
		"Delete fileä", noIcon, noKey, noMark, plain,
		/* [8] */
		"Directoryä", noIcon, noKey, noMark, plain,
		/* [9] */
		"Helpä", noIcon, noKey, noMark, plain,
		/* [10] */
		"Hostä", noIcon, noKey, noMark, plain,
		/* [11] */
		"Spaceä", noIcon, noKey, noMark, plain,
		/* [12] */
		"Typeä", noIcon, noKey, noMark, plain,
		/* [13] */
		"Whoä", noIcon, noKey, noMark, plain,
		/* [14] */
		"-", noIcon, noKey, noMark, plain,
		/* [15] */
...
resource 'MENU' (7) {
	...
	{	/* array: 3 elements */
		/* [1] */
		"Sessionä", noIcon, noKey, noMark, plain,
		/* [2] */
		"Dump screen to session log", noIcon, noKey, noMark, plain,
		/* [3] */
		"Transactionsä", noIcon, noKey, noMark, plain,
		/* [4] */
		"Packetsä", noIcon, noKey, noMark, plain,
		/* [5] */
		"Debugging", noIcon, noKey, noMark, plain,
		/* [6] */
		"Call Debugger", noIcon, noKey, noMark, plain
	}
};
resource 'MENU' (39) {
	7,
...
resource 'MENU' (8) {										/*JAO*/
	...
	{	/* array: 3 elements */
		/* [1] */
		"Print Captured Textä", noIcon, "P", noMark, plain,
		/* [2] */
		"Statusä", noIcon, noKey, noMark, plain,
		/* [3] */
		"Discard Captured Text", noIcon, noKey, noMark, plain
	}
};
resource 'MENU' (40) {										/*JAO*/
	8,
	textMenuProc,
	0x7FFFFFFF,
	disabled,
	...
	{	/* array: 3 elements */
		/* [1] */
		"Print Captured Textä", noIcon, noKey, noMark, plain,
		/* [2] */
		"Statusä", noIcon, noKey, noMark, plain,
		/* [3] */
		"Discard Captured Text", noIcon, noKey, noMark, plain
...
resource 'DITL' (257, purgeable, preload) {
	{	/* array DITLarray: 20 elements */
		...
		StaticText {
			disabled,
			"©1986ã1991 Columbia University, All Righ"
			"ts Reserved"
		},
		/* [5] */
		{26, 16, 58, 48},
...
resource 'DITL' (1009, preload, purgeable) {
	{	/* array DITLarray: 3 elements */
		...
		StaticText {
			...
			"ell, BS, DEL, ä enter a \\ followed by th"
...
data 'KSET' (4) {
	$"0000 0000 0000 3000 779E 7FD8 0000 001E"        /* ......0.w˚.ˇ.... */
	$"0000 0000 0000 2000 0100 0000 0000 0000"        /* ...... ......... */
	$"0000 0000 0000 0000 2284 0000 0000 0000"        /* ........"—...... */
...
data 'MSET' (5) {
	...
	$"9600 011E 01B2 0001 1E01 4808 0001 4D09"        /* Ò....æ....H...M– */
