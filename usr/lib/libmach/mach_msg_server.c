 ...
 * Revision 2.3  91/08/29  15:51:58  rpd
 * 	Fixed mach_msg_server to handle MACH_RCV_TOO_LARGE.
 * 	[91/08/22            rpd]
 * 
 * Revision 2.2  91/03/27  16:06:45  mrt
 * 	First checkin
 * 
 */
/*
 *	File:	mach_msg_server.c
 *	Author: Richard Draves, Carnegie Mellon University
 *	Date:	Jan, 1990
 *
 *	A simple generic server function. This is intended to be
 *	used as the message receive and demux function for
 *	servers using MIG interfaces
 */
